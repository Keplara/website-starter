...
// Create Group
router.post('/groups', requireAction('GroupCreate'), async (req, res) => {
  try {
...
// Read all Groups
router.get('/groups', requireAction('GroupRead'), async (req, res) => {
  try {
...
// Read single Group
router.get('/groups/:id', requireAction('GroupRead'), async (req, res) => {
  try {
...
// Update Group
router.put('/groups/:id', requireAction('GroupUpdate'), async (req, res) => {
  try {
...
// Delete Group
router.delete('/groups/:id', requireAction('GroupDelete'), async (req, res) => {
  try {
...
// Add member to group
router.post('/groups/:id/members', requireAction('GroupUpdate'), async (req, res) => {
  try {
...
router.delete('/groups/:id/members/:userId', requireAction('GroupUpdate'), async (req, res) => {
  try {
...
// Add policy to group
router.post('/groups/:id/policies', requireAction('gGroupUpdate'), async (req, res) => {
  try {
...
router.delete('/groups/:id/policies/:policyId', requireAction('GroupUpdate'), async (req, res) => {
  try {
