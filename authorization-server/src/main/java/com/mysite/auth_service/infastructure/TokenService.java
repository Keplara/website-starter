...
// public String createAccountToken(String emailAddress, String password, String
// username) {
...
// public ResetPasswordToken parseResetPasswordToken(String token) throws
// AuthApiException {
// ResetPasswordToken createResetPasswordJwt = new ResetPasswordToken();
// Claims claims = tokenBuilder.getClaims(token);
// createResetPasswordJwt.setEmailOrUsername((String)
// claims.get("emailOrUsername"));
