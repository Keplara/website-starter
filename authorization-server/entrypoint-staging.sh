...
REQUIRED_ENVS="EMAIL_PORT EMAIL_HOST EMAIL_MODE CLIENT_REGISTRATION_SECRET PORT AWS_S3_BUCKET AWS_S3_ENDPOINT AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY JWT_KEY JWT_PAYLOAD_KEY REDIS_HOST REDIS_USERNAME REDIS_PASSWORD REDIS_PORT MONGO_DATABASE MONGO_PORT MONGO_HOST MONGO_USERNAME MONGO_PASSWORD TRUSTSTORE_PASSWORD"
