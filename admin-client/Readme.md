...
Build image
`docker build --rm -f ./Dockerfile -t 010928192513.dkr.ecr.us-east-1.amazonaws.com/mysite/client .`

Run image locally
`docker run -p 80:8080 -d -t 010928192513.dkr.ecr.us-east-1.amazonaws.com/mysite/client`
...
Push image
`docker push 010928192513.dkr.ecr.us-east-1.amazonaws.com/mysite/client:latest`
